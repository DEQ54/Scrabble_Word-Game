...
public class GameLevelThree extends Application {
    static HBox top;
    static HBox middle;
    static String  word;
    ...
    public void start(Stage primaryStage) {
        ...
        Hint.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent actionEvent) {
                if(GameLevelThree.hint.getText()=="") {
                    GameLevelThree.hint.setText(LevelThreeProcessAlgorithm.getHint().toUpperCase());
                }else {
                    GameLevelThree.hint.setText("");
                }
            }
        });
    ...
    private void LevelSelection(int i) {
        switch(i) {
            case 3:
                ...
                middle = GameComponents.AnswerTiles(3);
